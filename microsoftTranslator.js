...
window['_mstConfig'] = {
    appId: 'Yxxx-vX8mPDa7pLJI9--dTQDp50FUfjtRXjNmCwdhlovl5IbDS9ZJuHXG3wc9uvwUyH4ErwKK5KC1N7ZpAmFLxJMqd3cpEw7OVD6aYKSDcdsBx7mJ0T75tLqVjFxO9-S0',
    ...
    imagePath: 'http\x3a\x2f\x2fwww.microsofttranslator.com\x2fstatic\x2f25550255\x2fimg\x2f',
    debug: false,
    locale: 'zh-chs',
    country: '',
    category: '',
...
Microsoft.Translator = new function () {
    var ub = "WidgetFloaterPanels", W = "hidden", J = "none", F = "8px", P = "pointer", cb = "2147483647",
        bb = "absolute", ib = "none", ab = "direction", hb = "&onerror=", M = "lang", V = "font", x = "img",
        E = "center", U = "false", D = "left", R = "right", w = 100, v = 255, B = "div", gb = "position", n = 400,
        r = "px", xb = "localizedLangs", i = "Original", ob = "ta", tb = "sv", o = "es", nb = "sr-latn", mb = "sr-cyrl",
        Z = "ru", Q = "pt", I = "no", sb = "ms", lb = "sw", rb = "it", Y = "de", g = "fr", X = "nl", qb = "zh-cht",
        kb = "zh-chs", fb = "ca", m = "ar", t = "rtl", d = "ltr", u = "&", T = "TRNS_ERROR_MSG", L = "none",
        O = "iframe", S = "string", f = 16, l = true, H = "number", K = "function", A = "undefined", N = "head",
        eb = "text/javascript", e = -1, s = "/", z = "_mstConfig", a = "en", k = false, jb = "/static/img/", b = "",
        j = null, q = this;
    ...
    q.BreakSentences = function (e, f, b, a, c, d) {
        return new y("BreakSentences", {appId: e, text: f, language: b}, a, c, d)
    };
    q.Detect = function (d, e, a, b, c) {
        return new y("Detect", {appId: d, text: e}, a, b, c)
    };
    q.DetectArray = function (d, e, a, b, c) {
        return new y("DetectArray", {appId: d, texts: e}, a, b, c)
    };
    q.GetAppIdToken = function (g, c, a, b, d, e, f) {
        return new y("GetAppIdToken", {appId: g, minRatingRead: c, maxRatingWrite: a, expireSeconds: b}, d, e, f)
    };
    q.GetLanguageNames = function (f, e, a, b, c, d) {
        return new y("GetLanguageNames", {appId: f, locale: e, languageCodes: a}, b, c, d)
    };
    q.GetLanguagesForSpeak = function (d, a, b, c) {
        return new y("GetLanguagesForSpeak", {appId: d}, a, b, c)
    };
    q.GetLanguagesForTranslate = function (d, a, b, c) {
        return new y("GetLanguagesForTranslate", {appId: d}, a, b, c)
    };
    q.GetTranslations = function (f, h, g, i, a, d, b, c, e) {
        return new y("GetTranslations", {appId: f, text: h, from: g, to: i, maxTranslations: a, options: d}, b, c, e)
    };
    q.Translate = function (f, h, g, i, a, c, b, d, e) {
        return new y("Translate", {appId: f, text: h, from: g, to: i, contentType: a, category: c}, b, d, e)
    };
    q.AddTranslationArray = function (f, a, g, h, d, b, c, e) {
        return new y("AddTranslationArray", {appId: f, translations: a, from: g, to: h, options: d}, b, c, e)
    };
    ...
    q.Speak = function (g, h, b, f, d, a, c, e) {
        return new y("Speak", {appId: g, text: h, language: b, format: f, options: d}, a, c, e)
    };
    q.TranslateArray = function (e, f, g, h, c, a, b, d) {
        return new y("TranslateArray", {appId: e, texts: f, from: g, to: h, options: c}, a, b, d)
    };
    q.TranslateArray2 = function (e, f, g, h, c, a, b, d) {
        return new y("TranslateArray2", {appId: e, texts: f, from: g, to: h, options: c}, a, b, d)
    };
    var c = {
        serviceClient: j,
        appId: b,
    ...
    var pb = c.serviceClient.LoadScript = new function () {
        function a(f, k) {
            ...
            if (a) {
                ...
                a = k.toString().match(/^([^:]*:\/\/[^\/]*)(\/[^\?\#]*)([\?][^#]*)*/);
                var h = a[1] || b, i = a[2] || b, d = f.substr(0, 1) == s ? [] : i.split(s);
                a = f.match(/^([^?]*)([\?][^#]*)*$/);
                var e = (a[1] || b).split(s), j = a[2] || b;
        ...
        return function (f, i, b) {
            ...
            if (h) h.appendChild(d); else b.documentElement.insertBefore(d, b.documentElement.firstChild);
            return d
        }
    }, Fb = new function () {
        var b = {
        ...
        return function (b) {
            if (b === undefined) return A; else if (b === j) return "null"; else if (typeof b.constructor === K && a[b.constructor]) return a[b.constructor]; else if (typeof b.nodeType === H && c[b.nodeType]) return c[b.nodeType];
            return typeof b
        }
    }, wb = new function () {
        var a = j;
        ...
        function r(a) {
            ...
            var b = a.charCodeAt(0), e = b.toString(f), g = encodeURIComponent(a),
                h = d.substr(0, d.length - e.length) + e;
            if (g.length < h.length && b > 34 || c.escapeNonAscii && b > 122) return g; else return h
        }
        ...
        var h, g = 0, d = window, f = (document.charset || document.characterSet || b).toLowerCase();
        ...
        return function (x, n, i, q, r) {
            var h = K, e = ++g, p, f, m = k, v = k, t = b, A = d["_mstc" + e] = function (a) {
                setTimeout(function () {
                    if (v) {
                        o(t);
                        return
    ...
    var h = new function () {
        ...
        a.absXPos = function (a) {
            if (a.getBoundingClientRect) return a.getBoundingClientRect().left + (Math.max(a.ownerDocument.documentElement.scrollLeft, a.ownerDocument.body.scrollLeft) - Math.max(a.ownerDocument.documentElement.clientLeft, a.ownerDocument.documentElement.offsetLeft)); else return A(a) + C(a)
        };
        ...
        a.absYPos = function (a) {
            if (a.getBoundingClientRect) return a.getBoundingClientRect().top + (Math.max(a.ownerDocument.documentElement.scrollTop, a.ownerDocument.body.scrollTop) - Math.max(a.ownerDocument.documentElement.clientTop, a.ownerDocument.documentElement.offsetTop)); else return D(a) + E(a)
        };
        ...
        var I = a.getBlockParent = function (a) {
            ...
            if (a.compatMode && a.compatMode.indexOf("CSS") != e) return p; else return l
        ...
        a.setGradient = function (a, b, c, d) {
            ...
            if (a._mstGradCol1 != b.toString() || a._mstGradCol2 != c.toString()) {
                ...
                if (b.toString() == c.toString()) a.style.backgroundColor = "#" + b.toString(); else if (y() && (!document.documentMode || document.documentMode < 8)) H(a, b, c, d); else {
        ...
        a.applyProtectiveCss = function (a) {
            var d = "content-box", c = "normal", b = L;
        ...
        var N = a.clone = function (a) {
            var c = {};
            for (var b in a) if (typeof a[b] === "object" && a !== j) c[b] = this.clone(a); else c[b] = a[b];
            return c
        };
    ...
    function C(e, d, c) {
        ...
        a.toString = function () {
            var c = "0" + this.r.toString(f), b = "0" + this.g.toString(f), a = "0" + this.b.toString(f);
    ...
    C.parse = function (a) {
        ...
        a = a.split(" ")[0];
        if (a.substr(0, 1) == "#") {
            if (a.length == 4) return new C(f * parseInt(a.substr(1, 1), f), f * parseInt(a.substr(2, 1), f), f * parseInt(a.substr(3, 1), f)); else if (a.length == 7) return new C(parseInt(a.substr(1, 2), f), parseInt(a.substr(3, 2), f), parseInt(a.substr(5, 2), f))
        } else if (C.nameTable[a.toLowerCase()]) return C.parse(C.nameTable[a.toLowerCase()]); else throw"Color format not suported: " + a;
    };
    C.nameTable = {
        Black: "#000000",
        Navy: "#000080",
    ...
    function Eb(Jb, nb, rb, ob, db, Gc, Cc, Q, J, Lc) {
        var ic = "Element too deep", K = "b", Kb = "LP", tb = H, v = b, g = j, bc = "scroll", ac = N, hb = " ", r = k,
            i = l, y = this, m = y, L = rb, P = ob, o = nb, Wb = db, vc = Gc, lb = Cc, Qb = [], I, bb, pc = J ? i : r,
            ib = i, Ec;
        ...
        var Bb, Lb = !Lc && !J, F = 0, G = 9, Y = 0, hc = 15, gc = w;
        ...
        var mb, cb, fb = 1400, sc = 1600, rc = (o.innerText || o.textContent).replace(/\s+/g, hb), Fb = 0, Sb = 0,
            xb = o.innerHTML.length, lc = 0, a = [o], X = [0], q = [{o: xb, p: 0}], Ub = [], S = [], nc = [], B = [],
            jb = [], Hb = r, eb = r, qc = r, Ib = r;
        y.text = rc;
        ...
        function Zb() {
            ...
            if (Ib) {
                Ib = r;
                if (s.size < G) if (J && Q) C(); else setTimeout(function () {
                    C()
                }, Y)
            }
        }
        ...
        var p = {Inherit: 0, On: 1, Off: 2, Skip: 3}, fc = {
                google: {value: {notranslate: p.Off}, content: {notranslate: p.Off}},
                microsoft: {value: {notranslate: p.Off}, content: {notranslate: p.Off}}
            }, dc = {translate: {"true": p.On, yes: p.On, "false": p.Off, no: p.Off, skip: p.Skip}},
            ec = {notranslate: p.Off, skiptranslate: p.Skip};
        if (Kc(o) == p.Off) {
            if (db) db(nb);
            return
        }
        ...
        var cc = {
            ...
            textarea: 1,
            noscript: 1
        }, sb = {hr: 1, option: 1, title: 1, br: 1, frame: 1, iframe: 1};
        ...
        function Ab(b) {
            var a;
            if (vb[b] == t) a = {direction: t, textAlign: R}; else a = {direction: d, textAlign: D};
            return a
        }
                ...
                if (bb && a && a.style && ab(a) && !m.sourceFrame && c.service != Kb && a.adjustAlign) for (var b in bb) try {
                    ...
                    if (d != bb[b]) {
                        ...
                        if (Lb) {
                            ...
                            if (a.style[b]) a._mstStyle[b] = a.style[b]; else a._mstStyle[b] = d
                        }
                        a.style[b] = bb[b]
                    }
                } catch (j) {
        ...
        function Ob(e) {
            var b = "_mssrc";
            if (!T) if (o.getElementsByTagName) T = o.getElementsByTagName(x); else if (o.documentElement.getElementsByTagName) T = o.documentElement.getElementsByTagName(x); else if (o.ownerDocument.documentElement.getElementsByTagName) T = o.ownerDocument.documentElement.getElementsByTagName(x);
            var a;
        ...
        function xc() {
            if (!I || !m.sourceFrame) {
                ...
                var d = jb.join(" | "), f = h.getStringByteCount(d);
                if (f > 128) d = d.substr(0, Math.round(d.length * 128 / f)) + "...";
                b.push("text=" + wb(d ? d : v));
                var o = z.length, n = 0, j = 0, g = 0, l = 0, i = 0, e = 0, k = 0;
                ...
                if (window.mscc === undefined || window.mscc.hasConsent()) {
                    if (typeof telemetry !== A && telemetry) telemetry.trackMetric([{
                        ...
                        value: o
                    }, {metric: "translation.errors", value: n}, {
                        metric: "translation.characters",
                        value: g
                    }, {metric: "translation.sentences", value: j}, {
                        metric: "tranlation.elements",
                        value: l
                    }, {metric: "translation.latencies", value: i}, {
                        metric: "translation.time",
                        value: k
                    }, {metric: "translation.to", value: P}, {metric: "translation.from", value: L}]);
        ...
        function kb(a) {
            if (a.nodeType == 3) return i; else if (a.nodeType != 1 || a._mstChunk || h.getStyleValue(a, "display").toLowerCase() != "inline" || h.getStyleValue(a, gb).toLowerCase() != "static" || sb[a.nodeName.toLowerCase()]) return r;
        ...
        function jc(b) {
            ...
            for (var h in dc) {
                var e = ub(b, h);
                if (e != g) {
                    var j = dc[h], f = j[e.toString().toLowerCase()];
                    a = f || a;
        ...
        function Kc(m) {
            var b = p.Inherit, k = m.ownerDocument.getElementsByTagName("meta");
            for (var d = 0; d < k.length; d++) {
                var l = k[d], c = ub(l, "name");
        ...
        function yc(d, e) {
            ...
            if (a && ab(a)) {
                ...
                if (pc && !m.sourceFrame) if (pc && I && I[a._mstHash]) {
                    var b = W(I[a._mstHash], K), f = W(a, K);
        ...
        function W(a, i, e) {
            ...
            for (var b = 0; b < a.childNodes.length; ++b) switch (a.childNodes[b].nodeType) {
                case 1:
                    ...
                    if (g == p.Skip && a.childNodes[b].previousSibling && a.childNodes[b].previousSibling.nodeType == 1) a.childNodes[b].previousSibling._mstSkipNext = f; else if (g == p.Skip && a.childNodes[b].nextSibling && a.childNodes[b].nextSibling.nodeType == 1) a.childNodes[b].nextSibling._mstSkipPrev = f; else {
                        d.push("<");
                        d.push(j);
                        d.push(">");
        ...
        function Z(a, f, j, b, c, h) {
            ...
            f.replace(new RegExp("<" + j + h + "(\\d+)>(.*)<\\/" + j + h + "\\1>", "gi"), function (m, q, o, l) {
                ...
                if (ab(i)) if (b) if (b[0] < m.length) {
                    ...
                    Z(i, o, j, g, g, h + 1);
                    b[0] -= m.length
                } else Z(i, o, j, g, g, h + 1); else if (b) {
                    if (b[0] < m.length) c.push([i], []); else c[c.length - 1].push(i);
        ...
        function Nc(a) {
            if (c.service == Kb && Default.Globals.PhraseAlignment) return a.replace(/[\s\xA0]/g, hb); else return a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\s\xA0]/g, hb)
        }

        function Eb(a) {
            if (c.service == Kb && Default.Globals.PhraseAlignment) return a; else return a.replace(/<\w+>/g, v).replace(/<\/\w+>/g, v).replace(/&gt;/gi, ">").replace(/&lt;/gi, "<").replace(/&amp;/gi, u)
        }
        ...
        function Ac() {
            var j = [], b = [], a = 0, f = h.getStringByteCount(S[0]);
            if (yb.length > 0 && !eb) {
                eb = i;
                var k = yb.shift();
                B = k.txt;
                a = k.length;
                nc = k.dom;
                var e = B[0], d = Math.floor(e.length * fb / a);
                B = [e.substr(0, d), e];
                while (h.getStringByteCount(B[0]) > fb && d > n) {
                    d = Math.floor(d / 2);
                    B = [e.substr(0, d), e]
                }
                cb = {aTxt: [], aSrcSnt: [], aTgtSnt: []};
                Db = new Date;
                Gb = B[0].length;
                qb = 1;
                mb = c.serviceClient.TranslateArray(Jb, [B[0]], L, P, c.category ? {Category: c.category} : g, mc, zb, lb);
            ...
            if (a > sc && (!I || !m.sourceFrame)) {
                ...
                s[F] = {Dom: j, Txt: b};
                s.size++;
                if (c.service == Kb) mb = c.serviceClient.TranslateArray2(Jb, b, L, P, c.category ? {Category: c.category} : g, Pb[F], Rb[F], lb); else mb = c.serviceClient.TranslateArray(Jb, b, L, P, c.category ? {Category: c.category} : g, Pb[F], Rb[F], lb);
            ...
            } else if (s.size < G) if (J && Q) C(); else setTimeout(function () {
                C()
            }, Y)
        }
        ...
        function mc(a) {
            ...
            var p = a[0].TranslatedText, f = a[0].OriginalTextSentenceLengths, j = a[0].TranslatedTextSentenceLengths,
                l = 0, o = 0;
            if (!(p && f && j)) {
                eb = i;
                zb(a[0].Error);
            ...
            if (B.length > 1) if (f.length < 1) C(); else {
                var b = B[1].substr(l), q = h.getStringByteCount(b), e = Math.floor(b.length * fb / q);
                ...
                var k = nc.shift(), u = rb || m.detectedLanguage;
                if (!Q && !J) {
                    bb = Ab(ob);
                    Vb(k)
                }
        ...
        function Nb(a) {
            var e = new Date, b = e.getTime() - Db.getTime();
            if (b > 13000) b = 13000;
            var c = 0;
            if (a) for (var d = 0; d < a.length; ++d) c += a[d].OriginalTextSentenceLengths.length; else c = qb;
            z.push({r: a ? "S" : "E", c: Gb, s: c, e: qb, l: b})
        }
        ...
        var kc = y.translateElement = function (a, n, l, j, k) {
            ...
            var d, h = a._mstHash;
            if (m.sourceFrame) d = a.cloneNode(i); else {
                d = a;
                a = d.cloneNode(i)
            }
            var o = j ? j.slice(0) : [], p = k ? k.slice(0) : [], e = [[]], f = [[]];
            try {
                Z(a, n, K, o, e);
                Z(d, l, K, p, f)
            } catch (q) {
        ...
        function uc(a, b, d) {
            if (!(a && b)) return;
            var f = a.textContent || a.innerText || v, g = b.textContent || b.innerText || v;
    ...
    var Bb = function () {
        ...
        var m = "object", i = H, o = "onComplete", f = K, h = S, c = k, d = l, n = xb, g = j;
        ...
        function a() {
            ...
            a.Links = new Hb(window._mstConfig["SignIn"] ? window._mstConfig["SignIn"] : b, window._mstConfig["SignOut"] ? window._mstConfig["SignOut"] : b, "http://go.microsoft.com/?linkid=9722454");
        ...
        a.prototype.SetUpdatedAccessToken = function (c) {
            ...
            f.src = (location && location.href && location.href.indexOf("https") == 0 ? "https://ssl." + a : "http://www." + a) + "/ajax/v3/WidgetV3.ashx?action=refreshToken&trnsaccesstoken=" + c + m;
    ...
    q.Widget = new Gb;
    var Cb = new function () {
        var e = k, g = e, m = 600, o = 430, q = "#0F0F5F", p = "#F0F0A0", s;
        return function (s, K, u, Q, z, w) {
            var X = "touchstart", W = "pointerup", V = "mouseout", U = "mouseover", G = L, A = l, v = this;
            ...
            if (!u) u = s;
            var y = e, H = e, O = s.style.color, M = s.style.backgroundColor, k = s.ownerDocument, N = e,
            ...
            var mb = v.show = function () {
                var gb = ab, W = a, N = "none 0px", fb = ib, eb = R, M = "normal", kb = "0px 0px 0px 0px", L = B, C = t;
                if (H) return; else H = A;
                if (!k._mstTooltip) {
                    var nb = c.baseURL.substr(0, 8) + c.baseURL.substr(8).replace(/\/.*$/, jb), X = e;
                    ...
                    if (!X) p.style.styleFloat = p.style.cssFloat = eb; else p.style.styleFloat = p.style.cssFloat = D;
                ...
                if (lb) g = h.absXPos(s) + s.offsetWidth - k._mstTooltip.offsetWidth; else g = h.absXPos(s);
            ...
            var T = v.hide = function () {
                ...
                }, kb = h.addEvent(s, U, S), lb = h.addEvent(s, V, fb),
                hb = h.addEvent(s, window.navigator.msPointerEnabled ? W : X, nb)
        }
    }, Ib = new function (H) {
        var nb = 1600, N = x, A = "span", v = B, eb = r, wb = j, i = L, w = J, C = ib, Lb = "MSTCTransPanel", Q = l,
            d = k, z = this, mc = 0, Db, Kb, Eb, zb, Ib, g, Bb, Z, gb, Cb, Xb, y, ub, kb, jb, fb, db, Wb, Y, Mb, ec, sb,
            Pb, ac, bc, Tb, dc, Ub, ic, lc, Jb, fc, a, G, mb, Zb, Ab, xb, qb, p, jc, lb = d, Fb = Q, gc = 1e6, m, o = 0,
            Gb, E, X;
        window._mstCmCb = function () {
            ...
            window.Microsoft.TranslatorOverride = {showTooltip: Yb, hideTooltip: yb};
        ...
        var Yb = z.showTooltip = function (a, b, c) {
            ...
            ob();
            ub.style.display = i;
            c.serviceClient.GetTranslations(c.appId, zb._mstNormalize(), Kb, Eb, 24, c.category ? {Category: c.category} : wb, Qb, Rb, 7e3);
            return d
        ...
        function Qb(a) {
            ...
            var u = mb >= 5 && mb >= Math.abs(a.Translations[0].Rating) && (!Ab || Ab == Eb.toLowerCase()),
                ...
                v = !a.NoEdit && a.Translations.length == 1, s = a.Reject, h, p = a.Translations.length;
        ...
        function vb(c) {
            if (lb) return d;
            if (!c) o = 0; else o += c;
            if (o < 0) o = 0; else if (o >= m.length) o -= 3;
            p.setLock(Q);
            for (var a = 0; a < m.length; ++a) if (a >= o && a < o + 3) m[a].panel.style.display = w; else m[a].panel.style.display = i;
            var f = o, e = Math.max(m.length - (o + 3), 0);
        ...
        function Sb(a, y, B, z) {
            var s = "4px 1px 0px 3px", r = "4px 3px 0px 1px", q = ab, e = this.panel = document.createElement(v);
            e.className = Lb;
            y.appendChild(e);
            a.OriginalText = zb._mstNormalize();
            var u = Ib._mstDenormalize(a.TranslatedText), l = document.createElement(v);
            ...
            b.appendChild(k);
            if (a.Rating > 5) {
                var i = document.createElement(A), w = document.createElement(N);
                w.src = c.imagePath + "ctfbadge.gif";
                i.appendChild(w);
                k.appendChild(i);
                if (a.Rating >= 10) i.style.backgroundColor = "#F2C341"; else if (a.Rating >= 8) i.style.backgroundColor = "#B2B2B2"; else if (a.Rating >= 6) i.style.backgroundColor = "#8C7853"
            } else if (a.Rating == 5) {
                var x = document.createElement(A), d = document.createElement(N);
                d.src = c.imagePath + "ctfmt.gif";
                d.style.margin = "2px 2px 0px 3px";
                x.appendChild(d);
                k.appendChild(x)
            } else if (a.Count) {
                var p = document.createElement(A), g = document.createElement(V);
                g.style.display = C;
            ...
            if (a.Flags) {
                ...
                n.style.height = "21px";
                j.appendChild(n);
                var o = document.createElement(A), f = document.createElement(V);
                f.style.display = C;
        ...
        function rb() {
            var a = b;
            if (!qb) a += "siteData=" + G; else a += "trnsaccesstoken=" + G;
            if (E) a += hb + E;
            return a
        }
        ...
        function tb(a, f, g) {
            ...
            if (e >= nb) b.pop();
            c.serviceClient.GetTranslationsArray(c.appId, b, f, g, 3, c.category ? {Category: c.category} : wb, function (d) {
                for (var c = 0; c < d.length; ++c) if (d[c].Translations.length > 1) if (d[c].Translations[0].Rating > 5) a.transItems[q + c].tgt.style.backgroundColor = "#E6E6E6"; else if (d[c].Translations[1].Count < 0) a.transItems[q + c].tgt.style.backgroundColor = "#E5917F"; else a.transItems[q + c].tgt.style.backgroundColor = "#B9E4FC";
                q += b.length;
                tb(a, f, g)
            }, function () {
        ...
        new function () {
            ...
            if (window.addEventListener) addEventListener("message", k, d); else attachEvent("onmessage", k)
        };
        c.serviceClient.Community = z
    }(c.baseURL), G;
    (function (h) {
        var Z = "dragging", Y = "__mstto=", q = "value", B = "{0}", v = L, V = "style", f = "LanguageMenu", p = J,
            X = z, m = l, d = k, x = j, s = {}, M, i, o = x, t = x, D = d, F, g, I, R, Q, P, n, S, T, hb = d, fb = m,
            C = d, E = m, eb = d, gb = d, O;

        function mb(r, h, a) {
            var e = "_bwmid", l = "Microsoft.Translator.OnMouseOverFloater()", k = "onmouseover", j = A;
            ...
            eb = m;
            if (window[e]) window[e] += ",translator"; else window[e] = "translator";
            pb("widget/metrics.js", (document.location.protocol == "https:" ? "https://ssl" : "http://www") + ".bing.com/");
            if (!hb && fb) {
        ...
        function H(d) {
            ...
            if (!gb) if (c = document.getElementById("WidgetLauncher")) {
                ...
                if (window["Util"].IsElementInViewport(c)) if (a.left == 0 && a.top == 0) setTimeout(function () {
                    ...
                    G(a.left, a.top)
                }, 200); else G(a.left, a.top); else G(50, 50)
            } else if (!c) G(50, 50);
            gb = m;
            y();
            db();
            ...
            var e = setInterval(function () {
                if (window[f]) {
                    ...
                    try {
                        ...
                        if (o == b) n.parentNode[V].display = v; else {
                            n.parentNode[V].display = p;
                            if (O) n.innerHTML = window[X].autoDetected.replace(B, s[o]); else n.innerHTML = s[o]
                        }
                    } catch (a) {
                        console.warn(a)
                    }
        ...
        function vb(g) {
            ...
            if (e && window[f] && window[f].getValue) {
                ...
                n.parentNode[V].display = p;
                if (O) n.innerHTML = window[X].autoDetected.replace(B, s[o]); else n.innerHTML = s[o];
                var k = s[e], h = s[window[f].getValue()],
        ...
        function jb() {
            ...
            if (location.search.length == 0) Util.GetElement(c).setAttribute(q, a + "?__mstto=" + i); else if (location.search.indexOf("__mstto") != e) {
                if (a.match(/__mstto=(.+)([&]+)/i)) Util.GetElement(c).setAttribute(q, a.replace(/__mstto=(.+)([&&]+)/i, Y + i + u)); else if (a.match(/__mstto=(.+)/i)) Util.GetElement(c).setAttribute(q, a.replace(/__mstto=(.+)/i, Y + i))
        ...
        function rb(a) {
            a = a || event;
            var b = Util.getPosition(g), c = a.clientX - S, e = a.clientY - T;
...
function CUtil() {
    var f = "character", e = true, d = false, b = null, c = -1, a = this, g = navigator.userAgent.toLowerCase();
    ...
    a.GetStyleObject = function (a) {
        if (document.getElementById && document.getElementById(a)) return document.getElementById(a).style; else if (document.all && document.all(a)) return document.all(a).style; else if (document.layers && document.layers[a]) return document.layers[a]; else return d
    };
    ...
    a.GetComputedStyle = function (e, c) {
        var a = document.getElementById(e) || document.body, d;
        if (window.getComputedStyle) d = document.defaultView.getComputedStyle(a, b).getPropertyValue(c); else if (a.currentStyle) d = a.currentStyle[c] || a.currentStyle.getAttribute(c.replace("-"));
        return d
    };
    ...
    a.GetCaretPosition = function (a) {
        var g = 0;
        if (a.selectionStart || a.selectionStart == "0") g = a.selectionStart; else if (document.selection) {
            var i = document.selection.createRange(), j = 0, k = 0;
            if (i && i.parentElement() == a) {
                var e = a.value.length, l = a.value.replace(/\r\n/g, "\n"), b = a.createTextRange();
                b.moveToBookmark(i.getBookmark());
                var h = a.createTextRange();
                h.collapse(d);
                if (b.compareEndPoints("StartToEnd", h) > c) j = k = e; else {
                    j = -b.moveStart(f, -e);
                    if (b.compareEndPoints("EndToEnd", h) > c) k = e; else k = -b.moveEnd(f, -e)
                }
            }
            g = j
        }
...
window['_mstConfig'].floaterStylePath = 'http://www.microsofttranslator.com/static/25550255/css/WidgetV3.css?v=25550255';
